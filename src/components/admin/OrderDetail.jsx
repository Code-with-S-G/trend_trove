          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-slate-50 dark:bg-[#2c2c2c] border-b border-slate-300 dark:border-slate-600">
                ...
                {/* <th className="px-6 py-4 text-sm font-bold text-gray-900 dark:text-gray-100">Pincode</th>
                ...
                <th className="px-6 py-4 text-sm font-bold text-gray-900 dark:text-gray-100">Date</th>
            ...
            <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
              <tr className="hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition-colors duration-200">
                ...
                <td className="px-6 py-4 text-sm text-gray-800 dark:text-gray-300">$299.00</td>
                <td className="px-6 py-4">
                  <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200">Completed</span>
                </td>
                <td className="px-6 py-4 text-sm text-gray-800 dark:text-gray-300">John Doe</td>
                <td className="px-6 py-4 text-sm text-gray-800 dark:text-gray-300">GAUTAM RANJAN Flat 256c, Third floor White House, Near Opposite Rastrapati Bhawan, near Red Fort, PMO Road 462024 • 09074063364</td>
                {/* <td className="px-6 py-4 text-sm text-gray-800 dark:text-gray-300">12345</td>
                <td className="px-6 py-4 text-sm text-gray-800 dark:text-gray-300">555-0123</td> */}
                <td className="px-6 py-4 text-sm text-gray-800 dark:text-gray-300">john@example.com</td>
                <td className="px-6 py-4 text-sm text-gray-800 dark:text-gray-300">2024-01-11</td>
                <td className="px-6 py-4">
                  <div className="flex items-center gap-3">
