      ...
      <div className="container">
        <div className="grid md:grid-cols-3 pb-44 pt-5">
          ...
          <div className="py-8 px-4">
            ...
            <p>Your satisfaction is our priority. We deliver exceptional service with every order.</p>
          </div>
          {/* Footer Links */}
          <div className="grid grid-cols-2 sm:grid-cols-3 col-span-2 md:pl-10">
            ...
            <div>
              <div className="flex items-center gap-3 mt-6">
                <a href="#">
                  <FaInstagram className="text-3xl hover:scale-105 hover:-translate-y-1 hover:text-amber-400 transition-all duration-200 ease-in-out" />
                </a>
                <a href="#">
                  <FaFacebook className="text-3xl hover:scale-105 hover:translate-y-1 hover:text-amber-400 transition-all duration-200 ease-in-out" />
                </a>
                <a href="#">
                  <FaLinkedin className="text-3xl hover:scale-105 hover:-translate-y-1 hover:text-amber-400 transition-all duration-200 ease-in-out" />
                </a>
              </div>
              <div className="mt-6">
